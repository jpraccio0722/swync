...
If you typed this code or hover over a function while holding <kbd>⌘</kbd> or <kbd>Ctrl</kbd> you will notice the tooltip for a lowpass has 3 arguments: audio, cuttoff and q. Yet we only typed two.
...
Each paramater can give me more control over the sound and make it a more flexble instrument. Play around with the settings and try different [signals](/docs/signals). 
