...
use crate::{scree_graph::{environment::Value, ugen_nodes::NodeKind}, lowerer::lower::Lowerer, parser::parser::{Arg, Ident}};
...
impl Lowerer {
    ...
    pub fn apply(
        &mut self,
        name: &str,
        def: Rc<crate::scree_graph::environment::FunctionDef>,
        arg_vals: Vec<Value>,
    ) -> Result<Value, String> {
